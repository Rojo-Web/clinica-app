            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" required class="form-control" id="name" placeholder="Edit nombre" name="nombre" value="{{$medico->nombre}}">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="last_name" placeholder="Edit apellido" name="apellido" value="{{$medico->apellido}}">
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="email" name="especialidad" placeholder="Especialidad" value="{{$medico->especialidad}}">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="horario_fecha" name="horarios" value="{{$medico->horarios}}" >
                    </div>
                </div>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email" placeholder="Edit email" value="{{$medico->email}}">
                        </div>
                    </div>
